...
- Username: `admin`
- Password: `Summit_Admin_2024!` (override with `KC_BOOTSTRAP_ADMIN_PASSWORD` env var)
...
OIDC_CLIENT_SECRET=summit-console-secret-change-in-prod
